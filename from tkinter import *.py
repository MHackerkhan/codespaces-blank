...
def download():
    ...
    try:
        ...
        video.download("C:/Users/Ibrohimov/Downloads")
...
master = Tk()
master.title("Telegram: @pythonturtlesourcecodes")
Label(master, text="Youtube Video Downloader -- Download Path: C:/Users/UserName/Downloads", fg="red", font=("Calibri", 15)).grid(sticky=N, padx=100, row=0)
